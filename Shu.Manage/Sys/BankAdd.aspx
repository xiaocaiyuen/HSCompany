<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankAdd.aspx.cs" Inherits="YDT.Web.Manage.Sys.BankAdd" %>
        ...
        <center>
            ...
            <table width="780" class="tab" border="0" cellpadding="10" cellspacing="1">
                ...
                <tr>
                    ...
                    <td width="270px">
                        <asp:TextBox ID="txtBank_Contact" runat="server" CssClass="input4 validate[required,maxSize[50]]" MaxLength="50" Style="width: 240px;"></asp:TextBox>
                    </td>
