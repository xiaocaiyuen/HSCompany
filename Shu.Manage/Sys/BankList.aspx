<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankList.aspx.cs" Inherits="YDT.Web.Manage.Sys.BankList" %>
            ...
            <table cellpadding="0" cellspacing="0" class="list_Index">
                <form id="form1" name="form1">
                    <tr>
                        ...
                        <td>
                            <input type="text" id="txtBank_Name" name="txtBank_Name" class="input4" />
                        </td>
                        <th>银行类型
                        </th>
                        <td>
                            <select id="ddlBank_Type" name="ddlBank_Type" class="input4" style="width: 150px;">
