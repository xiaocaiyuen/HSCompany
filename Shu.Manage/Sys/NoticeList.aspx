<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NoticeList.aspx.cs" Inherits="Shu.Manage.Sys.NoticeList" %>
        ...
        <div id="div_Select" style="float: left; width: 80%;display: none;">
            <table cellpadding="0" cellspacing="0" class="list_Index">
                ...
                <tr>
                    ...
                    <td>
                        <select id="ddlNotice_Type" name="ddlNotice_Type" class="input4" style=" width:150px;">
                        <%--<%listDataDict.ForEach(item =>
                              { %>
                                 <option value="<%=item.DataDict_Code=""%>"><%=item.DataDict_Name="===请选择==="%></option>
                            <%}); %>--%>
                            <%listDataDict.ForEach(item =>
                              { %>
                ...
                <tr>
                    ...
                    <td><%--
                        <input id="txt_TimeFrom" type="text" name="txt_TimeFrom" onclick="WdatePicker({dateFmt:'yyyy年MM月dd日'})"
                            style="width: 100px;" />--%>
                            <input type="text" id="txt_TimeFrom" name="txt_TimeFrom" class="input4"
