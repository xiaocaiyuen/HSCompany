            ...
            <div title="基本信息" style="padding: 10px">
                <table border="0" cellpadding="1" cellspacing="1" class="tab">
                    ...
                    <tr>
                        <th >按钮图标</th>
                        <td>
                            <input id="Icon" name="Icon" class="easyui-textbox" style="width: 98%;" data-options="required:true,readonly:false" />
                        </td>
                    </tr>
                    <tr>
                        <th >按钮事件</th>
                    ...
                    <tr>
                        <th >按钮类型</th>
                        <td>
                            <input id="Type" name="Type" class="easyui-textbox" style="width: 98%;" data-options="required:true,readonly:false" />
                        </td>
                    </tr>
                    <tr>
                        <th >按钮事件类型</th>
                        <td>
                            <input id="EventType" name="EventType" class="easyui-textbox" style="width: 98%;" data-options="required:true,readonly:false" />
                        </td>
                    </tr>
                    <tr>
