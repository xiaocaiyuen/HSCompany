<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCExpAllDeptUserEasyUISingleTree.ascx.cs"
    Inherits="Shu.Manage.UserControls.UCExpAllDeptUserEasyUISingleTree" %>
...
<script type="text/javascript">
    window.onload = function () {
        $('#tt2').tree({
            loadMsg: '加载中,请等候...',
            url: '/Handler/AsynDeptTree.ashx?Option=AllDeptUserCheckBoxData&pid=0&perseecharge=' + $('input[id*=hid_PerSeeCharge]').val() + '&depseecharge=' + $('input[id*=hid_DepSeeCharge]').val(),
